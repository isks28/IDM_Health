        ...
        .toolbar {
            ToolbarItem(placement: .navigationBarTrailing) {
                ...
                .sheet(isPresented: $showingInfo) {
                    VStack {
                        Text("Accelerometer Information")
                            .font(.title)
                            .multilineTextAlignment(.leading)
                            .padding(.top)
                        ScrollView {
                            Text("ACCELEROMETER measures UNFILTERED linear acceleration along the device's three axes (x, y, z). It detects changes in velocity and movement, helping track actions like shaking, tilting, or walking. This sensor is commonly used in fitness apps, motion control games, and various user interface interactions.")
                                .font(.callout)
                                .multilineTextAlignment(.leading)
                                .padding(.vertical, 5)
                            ...
                            Text("TIME-INTERVAL record the data automatically. Set the start and end date, turn on the Start timed recording, and the recording will stop automatically after the end time is up")
                                ...
                                .padding(.horizontal, 5)
                                .foregroundStyle(Color.primary)
                            Text("Data collection will stop if the accelerometer view is closed, but it will continue running even if the phone is locked or other apps are in use.")
                                .font(.body)
                                .multilineTextAlignment(.center)
                                .padding(.vertical, 10)
                                .padding(.horizontal, 5)
