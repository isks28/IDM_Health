                ...
                .sheet(isPresented: $showingInfo) {
                    VStack {
                        Text("Device Motion Information")
                            ...
                            .padding(.top)
                        ScrollView {
                        Text("The Device Motion data measures how the iPhone or Apple Watch moves and orients in space by combining filtered data from the accelerometer (linear acceleration), gyroscope (rotation rate), and magnetometer (strength and direction of magnetic fields). It also measures the gravity vector and the device’s attitude (orientation defined by roll, pitch, and yaw).")
                            .font(.callout)
                            .multilineTextAlignment(.leading)
                            .padding(.vertical, 5)
                        ...
                        Text("For more information go to:")
                            ...
                            .padding(.horizontal, 5)
                            .foregroundStyle(Color.primary)
                        Link("Apple developer documentation, getting processed device motion data", destination: URL(string: "https://developer.apple.com/documentation/coremotion/getting_processed_device-motion_data")!)
                            .font(.body)
                            .multilineTextAlignment(.leading)
                            .padding(.vertical, 5)
                            .padding(.horizontal, 5)
